...
// Source: session-7-db-pg-gorm/handler/user_handler.go
...
func (m *MockIUserHandler) GetUserByEmail(c *gin.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetUserByEmail", c)
}

// GetUserByEmail indicates an expected call of GetUserByEmail.
func (mr *MockIUserHandlerMockRecorder) GetUserByEmail(c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByEmail", reflect.TypeOf((*MockIUserHandler)(nil).GetUserByEmail), c)
}
